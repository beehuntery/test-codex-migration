...
| # | 項目 | ステータス | 備考 |
| --- | --- | --- | --- |
| 1 | `public/` ディレクトリの棚卸しおよび削除対象・保守対象のリストアップ | ✅ 完了 | レガシー資産棚卸し表にまとめ済み |
| 2 | README と運用ドキュメントを Next.js ベースへ更新 | ✅ 完了 | README, phase3/phase4 ドキュメント更新 |
| 3 | Cutover Runbook 初稿を作成 | ✅ 完了 | 下記 Runbook セクション参照 |
| 4 | CI パイプラインの通知・成否可視化を検討 | ✅ 完了 | Actions Summary + Slack 通知を整備 |
| 5 | Storybook/Playwright の追加シナリオを列挙 | ✅ 完了 | TODO リストに優先度を記載 |
| 6 | Next.js / Express 同期ポイントを整理 | ✅ 完了 | 同期ポイントセクション参照 |
| 7 | Cutover リハーサルを計画 | ✅ 完了 | リハーサル計画セクション参照 |
| 8 | 監視・アラート計画を策定 | ✅ 完了 | 監視・アラート計画セクション参照 |
| 9 | ステークホルダー向けコミュニケーションパックを準備 | ✅ 完了 | アナウンス文テンプレート/FAQ を整備 |
| 10 | Cutover 後の検証チェックリストを整理 | ✅ 完了 | ポストカットオーバー検証セクション参照 |
